...
// `refuseAnonymous: resolveRefuseAnonymous(process.env)` from the entrypoint left
 ...
 * resolveTrustProxyHops and resolveRefuseAnonymous for the individual contracts.
 *
...
export function appOptionsFromEnv(env) {
  return {
    ...
    refuseAnonymous: resolveRefuseAnonymous(env),
